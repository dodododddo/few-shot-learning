...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x, mask = None, return_all_tokens=False, return_attention=False):
        # mim
    ...
    def get_last_selfattention(self, x):
        ...
        for i, blk in enumerate(self.blocks):
            if i < len(self.blocks) - 1:
                ...
                return blk(x, return_attention=True)[1] # return attention matrix
...
@register('vit-small-fixed-num-patches')
